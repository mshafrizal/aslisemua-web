  ...
  <div class="black py-10">
    <v-container>
      <v-row>
        <v-col cols="12" sm="9">
          <v-row>
            <v-col cols="12" sm="3">
              ...
              <ul class="d-flex flex-column pa-0 mt-5">
                <li class="mb-2">
            ...
            <v-col cols="12" sm="3">
              ...
              <ul class="d-flex flex-column pa-0 mt-5">
                ...
                <li class="mb-2">
                  <router-link class="white--text" to="/">Terrms and Conditions</router-link>
                </li>
                <li class="mb-2">
        ...
        <v-col cols="12" sm="3" class="d-flex flex-column white--text text-center">
          <h2 class="text-3xl font-weight-bold">ASLISEMUA</h2>
