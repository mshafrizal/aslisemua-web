...
@section('content')
  <section id="categories" class="flex flex-col text-center mb-20">
    ...
    <div id="categories-wrapper" class="flex flex-col">
      <!--
    ...
    function loadCategory() {
      ...
      axios.get('{{route('categories-api')}}').then(result => {
        if (result.status === 200) {
          ...
          const chunk_size = 6;
          const groups = data.map( function(e,i){
          ...
          groups.forEach(group => {
            ...
            group.forEach(el => {
              ...
              img.src = "https://dummyimage.com/200x200/222222/eeeeee.png&text="+el.name;
              img.className = "mb-2";
              img.alt = "categories";
